...
public class PlayerAttack : MonoBehaviour
{
    ...
    void Update()
    {
        if(canAttack && !Movement.Instance.IsHiding() && !Movement.Instance.IsCrouching() && Input.GetMouseButtonDown(0) && Movement.Instance.IsGrounded() && !Movement.Instance.IsDead())
        {
            // play the animation
